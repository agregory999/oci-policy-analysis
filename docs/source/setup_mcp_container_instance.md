...
- IAM policy for the Container Instance dynamic group granting the read permissions needed by policy analysis.
...
6. Attach IAM policy for the container instance dynamic group (resource principal auth path).
