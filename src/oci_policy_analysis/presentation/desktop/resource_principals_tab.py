...
from oci_policy_analysis.application.core.models.models import DynamicGroup, RegularPolicyStatement
...
DG_COLUMN_WIDTHS = {
    ...
    'DG ID': 300,
    'Matching Rule': 700,
    'Matching Rule (parsed structure)': 280,
    'Matching Rule (elements)': 420,
    'In Use': 80,
    'Creation Time': 150,
    'Created By': 200,
    'Created By OCID': 250,
...
POLICY_COLUMN_WIDTHS = {
    ...
    'Match Confidence Reason': 420,
    'Principal Evidence': 420,
    'Residual Conditions': 420,
    'Comments': 200,
    'Parsing Notes': 250,
    'Creation Time': 150,
    'Parsed': 80,
...
class ResourcePrincipalsTab(BaseUITab):
    ...
    def _build_ui(self):
        ...
        filters_labelframe.grid_columnconfigure(9, weight=1)

        # Principals Style dropdown
        ttk.Label(filters_labelframe, text='Workload Principal Style:').grid(
        ...
        self.dg_labelframe = ttk.LabelFrame(frm_bottom_area, text='Dynamic Groups and Parsed Rules')
        ...
        # LabelFrame: Workload Principals Policy Table
    ...
    def update_principals_sheets(self, *args):
        ...
        if principals_style in ('any-user', 'any-group', 'any-user / any-group'):
            ...
            policies: list[RegularPolicyStatement] = self.principal_analysis.by_subject_types(
                ...
                resource_compartment_ocid=resource_compartment_ocid,
            ).statements
            ...
            self.resource_compartment_ocid_entry.configure(state='disabled')
