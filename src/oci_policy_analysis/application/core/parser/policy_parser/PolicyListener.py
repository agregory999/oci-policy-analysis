...
class PolicyListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PolicyParser#unaryComparison.
    def enterUnaryComparison(self, ctx:PolicyParser.UnaryComparisonContext):
        pass

    # Exit a parse tree produced by PolicyParser#unaryComparison.
    def exitUnaryComparison(self, ctx:PolicyParser.UnaryComparisonContext):
        pass
